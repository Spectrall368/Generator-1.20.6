...
@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD) public record ${name}SliderMessage(int sliderID, int x, int y, int z, double value) implements CustomPacketPayload {
