...
public class ${JavaModName}Boat extends Boat {
	...
	@Override protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(DATA_ID_TYPE, Type.${boatEntities[0].getModElement().getRegistryNameUpper()}.ordinal());
		<#else>
		builder.define(DATA_ID_TYPE, Type.${specialentities[0].getModElement().getRegistryNameUpper()}.ordinal());
		</#if>
	}
